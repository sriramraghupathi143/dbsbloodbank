...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable()
				...
				antMatchers("/addAcceptorRequest").permitAll().
				antMatchers("/updtaeAcceptorRequest").permitAll().
				antMatchers("/addDonation").permitAll().
				antMatchers("/updateDonationRequest").permitAll(). 
				antMatchers("/updateDonorRequest").permitAll().
				antMatchers("/sendNotifcation").permitAll().
